...
CREATE_THREAD(
	    ...
	    UINT32* dwThread, /* return thread id */
...
int main(){
    ...
    CREATE_THREAD(thread, NULL, 1024 * 1024,(UINT32*)&dwThreadId,(UINT32*) &dwThreadId);
    sleep(1);
    CREATE_THREAD(thread0, NULL, 1024 * 1024,(UINT32*)&dwThreadId,(UINT32*) &dwThreadId);
